...
def program():
    return compile_cairo_files(
        ...
        prime=DEFAULT_PRIME,
        debug_info=True,
        main_scope=ScopedName.from_string("src.stark_verifier.core.table_commitment"),
    )
...
def structs(program):
    return CairoStructFactory.from_program(
        program,
        additional_imports=[
            "src.stark_verifier.core.table_commitment.TableCommitment",
            ...
            "src.stark_verifier.core.vector_commitment.VectorCommitment",
